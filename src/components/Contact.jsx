...
export default function Contact() {
  return (
    <section
      id="contacts"
      className="w-full px-6 py-24 lg:px-16 lg:py-28 lg:flex flex-row-reverse justify-center items-start gap-x-10"
    >
      <div className="mb-10 basis-1/3">
        <h2 className="text-4xl lg:text-5xl text-center text-primary font-bold mb-3">
          Contacts
        </h2>
        <p className="basis-2/3 text-base lg:text-lg font-normal text-center">
          You can contact me via my email, messenger, and social media.
        </p>
      </div>
      <div className="grid grid-cols-2 gap-y-10 lg:flex lg:gap-x-10">
        <a
          href="mailto:alfonlai97@gmail.com"
          target="_blank"
          className="font-semibold flex flex-col items-center"
        >
          <MdEmail className="text-3xl lg:text-5xl" />
          Email
        </a>
        <a
        ...
        <a
          ...
          className="font-semibold flex flex-col items-center"
        >
          <FaWhatsapp className="text-3xl lg:text-5xl" />
          WhatsApp
        </a>
        <a
          ...
          className="font-semibold flex flex-col items-center"
        >
          <FaXTwitter className="text-3xl lg:text-5xl" />X
        </a>
      </div>
    </section>
  );
